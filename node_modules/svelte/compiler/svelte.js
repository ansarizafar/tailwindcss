...
class CompileError extends Error {
    constructor(message, template, startPos, filename, endPos = startPos) {
        super(message);
        this.toString = () => {
...
class ParseError extends CompileError {
    constructor(message, template, index, filename) {
...
class ValidationError extends CompileError {
    constructor(message, template, pos, filename) {
...
class Component extends Node$1 {
    ...
    build(block, parentNode, parentNodes) {
        ...
        const expression = (this.name === ':Self' ? generator.name :
        ...
        if (js) {
            ...
            if (defaultExport) {
                ...
                if (templateProperties.props) {
                    this.props = templateProperties.props.value.elements.map((element) => element.value);
                }
...
function dom(parsed, source, stylesheet, options) {
    ...
    return generator.generate(result, options, {
        banner: `/* ${filename ? `${filename} ` : ``}generated by Svelte v${"1.58.4"} */`,
        sharedPath,
        helpers,
        name,
        format,
