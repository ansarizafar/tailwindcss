(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getRenderStatement(compiler, namespace, name) {
	...
	`);
        ...
        return compiler.generate(result, options, {
            banner: `/* ${filename ? `${filename} ` : ``}generated by Svelte v${"2.2.0"} */`,
            sharedPath,
            name,
            format,
        });
    ...
    function ssr(ast, source, stylesheet, options, stats) {
		...
		${name}._render = function(__result, ctx, options) {
			...
			${computations.map(({ key, deps }) => `ctx.${key} = %computed-${key}(ctx);`)}
    ...
    class Stats {
        ...
        render(compiler) {
            ...
            const hooks = {};
            if (compiler.templateProperties.oncreate)
                hooks.oncreate = true;
            if (compiler.templateProperties.ondestroy)
